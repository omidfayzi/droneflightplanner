...
$bodyContent = '
    <!-- Hero Section -->
    <div class="min-h-screen flex flex-col justify-center items-center relative bg-cover bg-center" style="background-image: url(\'/app/assets/images/background_background.jpg\');">
        <!-- Overlay met extra afbeelding -->
        <div class="absolute inset-0" style="background-image: url(\'/app/assets/images/overlay_background.png\'); background-size: cover; background-position: center;"></div>
        <!-- Donkere overlay -->
        <div class="absolute inset-0 bg-black opacity-50"></div>
        <!-- Inhoud van de Hero -->
        <div class="relative z-10 text-center px-4">
            <img src="/app/assets/images/holding_the_drone_logo.png" alt="Holding the Drones" class="w-65 mx-auto mb-14">
        ...
        <div class="max-w-5xl mx-auto px-4">
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    <img src="/app/assets/images/fast_icon.svg" alt="Snel" class="w-16 mx-auto mb-10">
                    <h2 class="text-2xl font-bold mb-2">Snel</h2>
                    <p class="text-gray-700">Ervaar een snelle en efficiënte vluchtplanning.</p>
                </div>
                <div class="text-center">
                    <img src="/app/assets/images/secure_icon.svg" alt="Veilig" class="w-16 mx-auto mb-10">
                    <h2 class="text-2xl font-bold mb-2">Veilig</h2>
                    <p class="text-gray-700">Onze tools zorgen voor maximale veiligheid.</p>
                </div>
                <div class="text-center">
                    <img src="/app/assets/images/organized_icon.svg" alt="Overzichtelijk" class="w-16 mx-auto mb-10">
